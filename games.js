...
const GAMES = [
    ...
    { file:'connect4.html',       name:'Drop Four',       emoji:'🟡',  category:'board',        desc:'Drop discs in a line of four.',               tags:['strategy','2-player'],            keywords:['connect four','four in a row'], demo:true },
    ...
    { file:'klondike.html',       name:'Klondike',        emoji:'🏔️',  category:'strategy',       desc:'Arrange cards into foundation piles.',              tags:['cards','solitaire'],              keywords:['solitaire','cards'], demo:true },
    ...
    { file:'speedway.html',   name:'Speedway',        emoji:'🏁',  category:'construction', desc:'A fast race against the clock.',         scoreKey:'polePosition.bestScore',    tags:['racing','retro','3d'],                 keywords:['pole position','outrun','f1','arcade racer'], gamepad:true },
