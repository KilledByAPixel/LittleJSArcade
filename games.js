...
const GAMES = [
    ...
    // ---- Local URLs. ----
    { file:'2048.html',           name:'2048',            emoji:'🔢',  category:'puzzle',       desc:'Slide tiles, combine the numbers.',       scoreKey:'2048.bestScore',            tags:['grid','merge'],                           keywords:['threes','merge','numbers'], gamepad:true },
    ...
    { file:'homerDerby.html',       name:'Home Run Derby',     emoji:'⚾',  category:'sports',       desc:'Swing for the fences.',                   tags:['one-button','timing'],                     keywords:['baseball','home run derby','bat'], gamepad:true },
    ...
    { file:'brickout.html',       name:'Brickout',        emoji:'🧱',  category:'arcade',       desc:'Bounce the ball, break the bricks.',      scoreKey:'breakout.bestScore',        tags:['paddle','retro'],                 keywords:['breakout','arkanoid','bricks'], demo:true, gamepad:true },
    ...
    { file:'pillars.html',        name:'Pillars',         emoji:'💎',  category:'puzzle',       desc:'Rotate falling jewels, match three.',     scoreKey:'columns.bestScore',         tags:['falling','matching'],             keywords:['columns','tetris attack','jewels','gem stack'], gamepad:true },
    { file:'tankCombat.html',         name:'Tank Combat',     emoji:'🎖️', category:'construction', desc:'Two tanks, one cramped arena.',           tags:['multiplayer','retro'],            keywords:['combat','atari combat','tank duel','battle city'], gamepad:true },
    ...
    { file:'protector.html',       name:'Protector',       emoji:'🛸',  category:'construction', desc:'Blast aliens, rescue the humans.',        scoreKey:'defender.bestScore',        tags:['scrolling','rescue'],            keywords:['defender','stargate','humans','rescue'], gamepad:true },
    ...
    { file:'drPill.html',        name:'Dr. Pill',        emoji:'💊',  category:'puzzle',       desc:'Drop pills, wipe out the viruses.',       scoreKey:'drMario.bestScore',         tags:['falling','matching'],             keywords:['dr mario','dr robotnik','pills','virus','puzzle league'], gamepad:true },
    ...
    { file:'floppyBird.html',     name:'Floppy Bird',     emoji:'🐦',  category:'arcade',       desc:'Tap to flap past the pipes.',             scoreKey:'flappyBird.bestScore',      tags:['one-button','runner'],                     keywords:['flappy bird','tap'], demo:true, gamepad:true },
    ...
    { file:'froggit.html',        name:'Froggit',         emoji:'🐸',  category:'arcade',       desc:'Dodge traffic, cross the river.',         scoreKey:'frogger.bestScore',         tags:['classic','retro'],                        keywords:['frogger','crossy road','frog'], top:9, demo:true, gamepad:true },
    { file:'geometryJump.html',   name:'Geometry Jump',   emoji:'🔺',  category:'arcade',       desc:'Jump over the obstacles.',                scoreKey:'geometryDash.bestProgress', tags:['runner','rhythm'],                keywords:['geometry dash','rhythm runner','spikes'], demo:true, gamepad:true },
    ...
    { file:'jetdash.html',    name:'Jetdash',         emoji:'🪂',  category:'construction', desc:'Boost, glide, dodge the obstacles.',      scoreKey:'jetpackDash.bestScore',     tags:['runner','one-button'],            keywords:['jetpack joyride','endless runner','jetpack'], gamepad:true },
    ...
    { file:'boomer.html',         name:'Boomer',          emoji:'💣',  category:'arcade',       desc:'Catch every bomb the bomber drops.',      scoreKey:'kaboom.bestScore',          tags:['paddle','retro'],                 keywords:['kaboom','atari kaboom','mad bomber'], demo:true, gamepad:true },
    ...
    { file:'missileDefense.html', name:'Missile Defense', emoji:'🏙️', category:'arcade',      desc:'Shoot down the missiles.',        scoreKey:'missileCommand.bestScore',  tags:['defense','aim'],              keywords:['missile command','nuke defense','abm','cold war'], top:1, demo:true, gamepad:true },
    ...
    { file:'pucMan.html',         name:'Maze Munch',         emoji:'👻',  category:'arcade',       desc:'Eat dots, dodge the ghosts.',             scoreKey:'pacman.bestScore',          tags:['maze','retro'],                   keywords:['pac-man','pacman','ms pacman','ghosts','maze chase'], demo:true, gamepad:true },
    { file:'pegball.html',         name:'Pegball',         emoji:'🟢',  category:'physics',      desc:'Aim, drop, clear every peg.',             scoreKey:'peggle.bestScore',          tags:['physics','aim'],                  keywords:['peggle','pachinko','peg shooter'], gamepad:true },
    ...
    { file:'plinko.html',         name:'Plinker',         emoji:'🔵',  category:'physics',      desc:'Drop chips down the pegs.',               scoreKey:'plinko.bestScore',          tags:['physics','luck'],                 keywords:['plinko','price is right','pachinko'], gamepad:true },
    { file:'speedway.html',   name:'Speedway',        emoji:'🏁',  category:'construction', desc:'Hug the curves, beat the clock.',         scoreKey:'polePosition.bestScore',    tags:['racing','retro','3d'],                 keywords:['pole position','outrun','f1','arcade racer'], gamepad:true },
    { file:'pong.html',           name:'Pong',            emoji:'🏓',  category:'sports',       desc:'Two paddles, one bouncing ball.',         tags:['paddle','retro'],                 keywords:['pong','tennis','table tennis'], demo:true, gamepad:true },
    ...
    { file:'gemFighter.html',  name:'Gem Fighter',     emoji:'💢',  category:'construction', desc:'Stack gems, chain big combos.',           tags:['falling','matching'],               keywords:['puzzle fighter','super puzzle fighter','street fighter puzzle'], gamepad:true },
    { file:'riverStrike.html',      name:'River Strike',    emoji:'✈️', category:'construction', desc:'Down enemy ships, collect fuel.',         scoreKey:'riverRaid.bestScore',       tags:['scrolling','classic'],            keywords:['river raid','xevious','vertical shmup'], gamepad:true },
    ...
    { file:'snake.html',          name:'Snake',           emoji:'🐍',  category:'arcade',       desc:'Eat, grow, and don’t crash.',             scoreKey:'snake.bestScore',           tags:['grid','classic'],                 keywords:['snake','nokia snake','tron'], demo:true, gamepad:true },
    ...
    { file:'spaceIntruders.html',  name:'Space Intruders', emoji:'👾',  category:'shooter',      desc:'Shoot the marching aliens.',          scoreKey:'spaceInvaders.bestScore',   tags:['retro','space'],                 keywords:['space invaders','galaga','galaxian','aliens'], top:7, demo:true, gamepad:true },
    ...
    { file:'tetrix.html',         name:'Tetrix',          emoji:'🟪',  category:'puzzle',       desc:'Stack the blocks to clear lines.',      scoreKey:'tetris.bestScore',          tags:['falling','classic'],              keywords:['tetris','tetrimino','blocks'], top:6, demo:true, gamepad:true },
    ...
    { file:'wulfstein.html',    name:'Wulfstein',       emoji:'🐺',  category:'construction', desc:'Shoot your way out.',       tags:['first-person','maze','3d'],         keywords:['wolfenstein','wolf','doom','fps','3d shooter','raycaster'], gamepad:true },
