...
const GAMES = [
    ...
    { file:'blastman.html',       name:'Blastman',        emoji:'💣',  category:'arcade',       desc:'Bomb the blocks and blast every baddie.',      scoreKey:'Blastman.bestScore',        tags:['grid','classic'],                 keywords:['bomberman','dyna blaster','bombs','maze','explode'], gamepad:true },
